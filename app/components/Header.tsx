 ...
 src="/images/img1.png"
  ...
  className="object-contain"/></div>
    ...
    <header className="bg-white border-b shadow-sm">
      ...
      <div className="flex justify-between items-center px-4 md:px-8 py-2">
        ...
        <a href="/sale" className="text-black hover:underline">
            New & Featured
          </a>
          <a href="/sale" className="text-black hover:underline">
            Men
          ...
          <a href="/snkrs" className="text-black hover:underline">
            SNKRS
          </a>
        </nav>
  ...
  <div className="flex items-center space-x-4">
      ...
      <div className="md:hidden bg-white w-full px-4 py-3 hidden" id="mobile-menu">
        <a href="/featured" className="block text-black py-1 hover:underline">
          New & Featured
        </a>
        <a href="/men" className="block text-black py-1 hover:underline">
          Men
        </a>
        <a href="/women" className="block text-black py-1 hover:underline">
          Women
        </a>
        <a href="/kids" className="block text-black py-1 hover:underline">
          Kids
        </a>
        <a href="/snkrs" className="block text-black py-1 hover:underline">
          SNKRS
        </a>
      </div>
    </header>
